...
<div class="container mt-5">
  ...
  <div class="row g-3">
    ...
    <div class="col-12 text-center">
      <label class="fw-bold mb-2 d-block">Profile Avatar</label>
      <div>
        <?php
        $avatarPath = !empty($user['avatar']) 
          ? "/vrms-project/assets/img/avatars/" . htmlspecialchars($user['avatar']) 
          : "/vrms-project/assets/img/avatars/default.jpg";
        ?>
        <img src="<?= $avatarPath ?>" class="mb-3 rounded-circle border" style="width: 120px; height: 120px; object-fit: cover;" />
      </div>
      <input type="file" name="avatar" class="form-control w-auto mx-auto">
